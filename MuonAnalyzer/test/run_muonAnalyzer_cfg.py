...
options.register('era', 'Run2017_UL',
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "era"
)
...
if options._beenSet['globalTag'] and options.globalTag != '':
    ...
    if options.isMC:
        if options.era == "Run2017_UL": globaltag = "106X_mc2017_realistic_v9"
        elif options.era == "Run2018_UL": globaltag = "106X_upgrade2018_realistic_v16_L1v1"
    else: 
...
if len(options.inputFiles) == 0:
    if options.resonance == 'Z':
        if options.isFullAOD:
            ...
            if options.isMC:
                options.inputFiles.append('/store/mc/RunIISummer20UL17MiniAODv2/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/MINIAODSIM/106X_mc2017_realistic_v9_ext1-v1/40000/009A23B1-CC83-F04B-A7A6-175F0A369038.root')
            else:
